...
class ConfigDialog(QDialog):
    ...
    def init_ui(self):
        ...
        # Nuove impostazioni Driver Kernel
        self.cb_start_with_driver = QCheckBox()
        self.cb_start_with_driver.setChecked(self.config.get("start_with_driver", False))
        general_layout.addRow("Carica driver all'avvio:", self.cb_start_with_driver)

        self.cb_auto_enable_hooks = QCheckBox()
        self.cb_auto_enable_hooks.setChecked(self.config.get("auto_enable_hooks", False))
        general_layout.addRow("Attiva hook automaticamente:", self.cb_auto_enable_hooks)
    ...
    def get_config(self):
        ...
        # Salva nuove impostazioni driver
        self.config["start_with_driver"] = self.cb_start_with_driver.isChecked()
        self.config["auto_enable_hooks"] = self.cb_auto_enable_hooks.isChecked()
